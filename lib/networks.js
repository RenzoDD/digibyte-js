...
addNetwork({
  name: 'livenet-native',
  alias: 'mainnet-native',
  pubkeyhash: 0x1E,         // PUBKEY_ADDRESS
  privatekey: 0x80,         // SECRET_KEY
  scripthash: 0x3F,         // SCRIPT_ADDRESS
  bech32prefix: 'dgb',      // bech32_hrp
  xpubkey: 0x049D7CB2,      // EXT_PUBLIC_KEY
  xprivkey: 0x049D7878,     // EXT_SECRET_KEY
  networkMagic: 0xFAC3B6DA, // pchMessageStart
  port: 12024,              // nDefaultPort
  dnsSeeds: [               // vSeeds
    'seed.digibyte.org',
...
/**
 * @instance
 * @member Networks#livenet-native
 */
var livenetNative = get('livenet-native');


addNetwork({
  name: 'livenet-segwit',
  alias: 'mainnet-segwit',
  pubkeyhash: 0x1E,         // PUBKEY_ADDRESS
  privatekey: 0x80,         // SECRET_KEY
  scripthash: 0x3F,         // SCRIPT_ADDRESS
  bech32prefix: 'dgb',      // bech32_hrp
  xpubkey: 0x04B24746,      // EXT_PUBLIC_KEY
  xprivkey: 0x04B2430C,     // EXT_SECRET_KEY
  networkMagic: 0xFAC3B6DA, // pchMessageStart
  port: 12024,              // nDefaultPort
  dnsSeeds: [               // vSeeds
    'seed.digibyte.org',
...
/**
 * @instance
 * @member Networks#livenet-segwit
 */
var livenetSegwit = get('livenet-segwit');
...
addNetwork({
  ...
  scripthash: 0x05,         // SCRIPT_ADDRESS
  bech32prefix: 'dgb',      // bech32_hrp
  xpubkey: 0x0488B21E,      // EXT_PUBLIC_KEY
  xprivkey: 0x0488ADE4,     // EXT_SECRET_KEY
  networkMagic: 0xFAC3B6DA, // pchMessageStart
...
/**
 * @instance
 * @member Networks#oldnet
 */
var oldnet = get('oldnet');
...
addNetwork({
  ...
  scripthash: 0x8C,         // SCRIPT_ADDRESS
  bech32prefix: 'dgbt',     // bech32_hrp
  xpubkey: 0x044A5262,      // EXT_PUBLIC_KEY
  xprivkey: 0x044A4E28,     // EXT_SECRET_KEY
  networkMagic: 0xFDC8BDDD, // pchMessageStart
  port: 12026,              // nDefaultPort
  dnsSeeds: [               // vSeeds
    'seed.testnet-1.us.digibyteservers.io',
...
/**
 * @instance
 * @member Networks#testnet-native
 */
var testnetNative = get('testnet-native');
...
addNetwork({
  ...
  scripthash: 0x8C,         // SCRIPT_ADDRESS
  bech32prefix: 'dgbt',     // bech32_hrp
  xpubkey: 0x045F1CF6,      // EXT_PUBLIC_KEY
  xprivkey: 0x045F18BC,     // EXT_SECRET_KEY
  networkMagic: 0xFDC8BDDD, // pchMessageStart
  port: 12026,              // nDefaultPort
  dnsSeeds: [               // vSeeds
    'seed.testnet-1.us.digibyteservers.io',
...
/**
 * @instance
 * @member Networks#testnet-segwit
 */
var testnetSegwit = get('testnet-segwit');
...
module.exports = {
  ...
  livenet: livenet,
  livenetNative: livenetNative,
  livenetSegwit: livenetSegwit,
  mainnet: livenet,
  oldnet: oldnet,
  testnet: testnet,
  testnetNative: testnetNative,
  testnetSegwit: testnetSegwit,
  regtest: regtest,
  get: get,
