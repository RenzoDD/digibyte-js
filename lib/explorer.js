...
class Explorer {
    ...
    async blockHash(height) {
        return this.#getData(this.url + "block-index/" + height);
    }
    ...
    async transaction(txid) {
        return this.#getData(this.url + "tx/" + txid);
    }
    ...
    async address(address, options = {}) {
        ...
        return this.#getData(this.url + "address/" + address + params);
    }
    ...
    async xpub(xpub, type = null, options = {}) {
        ...
        return this.#getData(this.url + "xpub/" + xpub + params);
    }
    ...
    async utxo(descriptor, type = null, options = {}) {
        ...
        return this.#getData(this.url + "utxo/" + descriptor + params);
    }
     ...
     */
    async block(block) {
        return this.#getData(this.url + "block/" + block);
    }
     ...
     */
    async sendtx(hex) {
        return this.#postData(this.url + "sendtx/", hex);
    }
