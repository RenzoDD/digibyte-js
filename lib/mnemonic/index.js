...
var Mnemonic = function (data, wordlist) {
  ...
  if (ent % 32 !== 0 || ent < 32 || ent > 256) {
    throw new Errors.InvalidArgument('ENT', 'Values must be ENT > 32 and ENT < 256 and ENT % 32 == 0');
  }
 ...
 * Optionally receive a passphrase and digibyte network.
 *
 * @param {String=} [passphrase]
