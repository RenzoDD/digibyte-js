...
RPC.prototype.call = async function () {
    ...
    try {
        ...
        var response = await fetch(`http://${this.host}:${this.port}/`, {
            method: 'POST',
            headers: {
 ...
 * @returns {Promise<>}
 */
RPC.prototype.listLastBlocks = async function (limit) {
...
/**
 * @param {number} numberOfRecords - numberOfRecords
 * @param {number} startIndex - startIndex
 * @param {boolean} basicOutput - basic output
 * @param {{psp:bool|int}} filter
 * @returns {Promise<{assetId:string, assetIndex:number, cid:string, height:number}[]>}
 */
RPC.prototype.listLastAssets = async function (numberOfRecords, startindex, basicOutput, filter) {
 ...
 * @returns {Promise<{assetId:string, assetIndex:number, cid:string, height:number}[]>}
 */
RPC.prototype.listLastAssetsPageIndexes = async function (numberOfRecords, filter) {
 ...
 * @returns {Promise<{assetId:string, assetIndex:number, cid:string, height:number}[]>}
 */
RPC.prototype.listAssetIssuances = async function (assetId) {
