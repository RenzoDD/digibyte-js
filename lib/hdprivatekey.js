 ...
 * @param {*} network
 * @param {Boolean} mobile - DigiByte Mobile compatibility
 * @return HDPrivateKey
 */
HDPrivateKey.fromSeed = function(hexa, network, mobile = false) {
  ...
  var hash = Hash.sha512hmac(hexa, Buffer.from(mobile ? 'DigiByte seed' : 'Bitcoin seed'));
