...
Represents a DigiByte public key and is needed to be able to receive DigiByte, as is usually represented as a DigiByte [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
